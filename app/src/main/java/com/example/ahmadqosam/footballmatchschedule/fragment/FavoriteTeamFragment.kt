...
import com.example.ahmadqosam.footballmatchschedule.adapter.FavoriteTeamAdapter
...
import com.example.ahmadqosam.footballmatchschedule.fragment.FavoriteTeamFragment.Ids.favorite_team_list
...
class FavoriteTeamFragment : Fragment(), AnkoComponent<Context> {
    ...
    object Ids {
        const val favorite_team_list = 22
    }
}
